    ...
    <footer css={footerStyles()}>
      <Section className={`${hideHire && hideSocial ? 'mt-0' : ''}`}>
        <Container>
          ...
          <Row>
            <Col fraction={1}>
              <a href="https://www.buymeacoffee.com/alvinf" 
                target="_blank"
                rel="noreferrer">
                <img src="https://img.buymeacoffee.com/button-api/?text=Buy%20me%20a%20coffee&emoji=&slug=alvinf&button_colour=c03228&font_colour=ffffff&font_family=Cookie&outline_colour=ffffff&coffee_colour=FFDD00" />
                </a>
            </Col>
          </Row>
          <Spacing size={1} />
