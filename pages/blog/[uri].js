...
import { fileBaseUrl, blogSingle, blogSingle2 } from '../../constants/defaultValues';
    ...
    >
      ...
      <Section data-aos="fade-up" className="pt-0 pb-0">
        <Container>
          ...
          <Row>
            <Col fraction={1}>
              <H3>{blogSingle2.title}</H3>
              <Button href={blogSingle2.previewUrl} color="secondaryOutline">
